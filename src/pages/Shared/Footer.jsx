      ...
      <div class="bg-gray-100">
        <div class="max-w-6xl m-auto text-gray-800 flex flex-wrap justify-center">
          ...
          <div class="p-5 w-48 ">
            ...
            <Link class="my-3 block" to="/sign-in">
              Sign in <span class="text-teal-600 text-xs p-1"></span>
            </Link>
            <Link class="my-3 block" to="/sign-up">
          ...
          <div class="p-5 w-48 ">
            ...
            <Link class="my-3 block" to="/">
              12/10 Rangpur, Dhaka, Bangladesh
              <span class="text-teal-600 text-xs p-1"></span>
            </Link>
            <Link class="my-3 block" to="/">
              info@best-recipes.com
              <span class="text-teal-600 text-xs p-1"></span>
            </Link>
          </div>
        </div>
